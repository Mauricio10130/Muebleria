...
class Cart(models.Model):
	...
	user = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE)# Relación uno a muchos, entre usuario y carts(carrito)
...
#Creando la tabla intermedia entre carrito(cart) y productos(product)
class CartProducts(models.Model): #relación entre un carrito y un producto, el cuál es de muchos a muchos
