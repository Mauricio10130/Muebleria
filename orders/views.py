...
from django.contrib.auth.decorators import login_required # validando para que solo accedan usuarios registrados
...
@login_required(login_url='login')	# validando para que solo accedan usuarios registrados
